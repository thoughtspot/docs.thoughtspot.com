...
- *xref:8.0.0.cl@cloud:ROOT:chart-table.adoc[Table column summaries and headlines]* with conditional and number formatting, and updated *xref:8.0.0.cl@cloud:ROOT:search-spotiq-settings#search.adoc[Search and SpotIQ]* panels of the Admin console
...
- *xref:8.0.0.cl@cloud:ROOT:search-conditional-formatting.aodc#table[Conditional formatting]* for pivot tables in chart configuration
...
- More intuitive UI for *xref:8.0.0.cl@cloud:ROOT:spotiq-custom.aodc#new-answer-experience[SpotIQ]* analysis of answer data points, which surfacing the most useful workflows and enables advanced customization
